...
set_property -dict { PACKAGE_PIN K17  IOSTANDARD LVCMOS33 } [get_ports { SCL }]; #IO_L12N_T1_MRCC_14 ,Sch=JC1
set_property -dict { PACKAGE_PIN M18  IOSTANDARD LVCMOS33 } [get_ports { SDA }]; #IO_L11P_T1_SRCC_14 ,Sch=JC2
