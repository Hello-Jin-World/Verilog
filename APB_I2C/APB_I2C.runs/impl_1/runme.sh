...
HD_PWD='D:/GitHub/verilog/Verilog/APB_I2C/APB_I2C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2C_Master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2C_Master.tcl -notrace
