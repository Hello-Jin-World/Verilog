...
HD_PWD='D:/GitHub/harman_Verilog/check_duplication/check_duplication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log check_dupl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source check_dupl.tcl
