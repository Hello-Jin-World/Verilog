...
HD_PWD='D:/GitHub/harman_Verilog/1205dedicated_processer_counter/1205dedicated_processer_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dedicated.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dedicated.tcl
