...
HD_PWD='D:/GitHub/harman_Verilog/1205dedicated_processer_counter/1205dedicated_processer_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dedicated.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dedicated.tcl -notrace
