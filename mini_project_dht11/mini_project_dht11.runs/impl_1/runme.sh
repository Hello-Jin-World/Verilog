...
HD_PWD='D:/Verilog/Verilog/mini_project_dht11/mini_project_dht11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_dht11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_dht11.tcl -notrace
