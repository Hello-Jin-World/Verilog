...
HD_PWD='D:/Verilog/Verilog/1115_uart_study_windows/1115_uart_study_windows.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log send_char.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source send_char.tcl
