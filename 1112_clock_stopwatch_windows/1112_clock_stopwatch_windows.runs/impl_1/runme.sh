...
HD_PWD='D:/GitHub/harman_Verilog/1112_clock_stopwatch_windows/1112_clock_stopwatch_windows.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_stopwatch_clock.tcl -notrace
