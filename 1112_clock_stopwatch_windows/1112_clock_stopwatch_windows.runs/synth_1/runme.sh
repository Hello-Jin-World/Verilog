...
HD_PWD='D:/GitHub/harman_Verilog/1112_clock_stopwatch_windows/1112_clock_stopwatch_windows.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_stopwatch_clock.tcl
