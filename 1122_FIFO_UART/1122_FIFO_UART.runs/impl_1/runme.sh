...
HD_PWD='D:/GitHub/harman_Verilog/1122_FIFO_UART/1122_FIFO_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_fifo_loopback.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_fifo_loopback.tcl -notrace
