...
HD_PWD='D:/GitHub/harman_Verilog/1122_FIFO_UART/1122_FIFO_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_fifo_loopback.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_fifo_loopback.tcl
