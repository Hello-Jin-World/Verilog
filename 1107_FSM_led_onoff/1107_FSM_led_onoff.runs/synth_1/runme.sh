...
HD_PWD='D:/GitHub/harman_Verilog/1107_FSM_led_onoff/1107_FSM_led_onoff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_led.tcl
