...
HD_PWD='D:/GitHub/harman_Verilog/1107_FSM_led_onoff/1107_FSM_led_onoff.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_led.tcl -notrace
