...
module OV7670_config_rom (
    ...
    always @(posedge clk) begin
        case (addr)
            ...
            2: dout <= 16'h12_0C;  // COM7,     set QVGA + RGB format
            3: dout <= 16'h11_80;  // CLKRC     internal PLL matches input clock
            4: dout <= 16'h0C_08;  // COM3,     enable scaling for QQVGA
            5: dout <= 16'h3E_00;  // COM14,    no scaling, normal pclock
            6: dout <= 16'h04_00;  // COM1,     disable CCIR656
            7: dout <= 16'h40_d0;  //COM15,     RGB565, full output range
            8: dout <= 16'h3a_04;  //TSLB       set correct output data sequence
            9: dout <= 16'h14_10;  //COM9       MAX AGC value x4
            10: dout <= 16'h4F_70;  //MTX1
            11: dout <= 16'h50_70;  //MTX2 
            12: dout <= 16'h51_00;  //MTX3
            13: dout <= 16'h52_22;  //MTX4 
            14: dout <= 16'h53_5E;  //MTX5 
            15: dout <= 16'h54_80;  //MTX6 
            16: dout <= 16'h58_9E;  //MTXS
            17: dout <= 16'h3D_C0;  //COM13      sets gamma enable
            18: dout <= 16'h17_14;  //HSTART     start high 8 bits
            19: dout <= 16'h18_02;  //HSTOP      stop high 8 bits
