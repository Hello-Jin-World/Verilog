...
HD_PWD='D:/GitHub/verilog/Verilog/TeamProject_StereoDepth_HO/TeamProject_StereoDepth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_CAMERA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_VGA_CAMERA.tcl -notrace
