...
# set_property -dict { PACKAGE_PIN P17  IOSTANDARD LVCMOS33 } [get_ports { ov7670_v_sync }]; #IO_L13N_T2_MRCC_14 ,Sch=JC9
# set_property -dict { PACKAGE_PIN R18  IOSTANDARD LVCMOS33 } [get_ports { ov7670_pclk }]; #IO_L14N_T2_SRCC_14 ,Sch=JC10
