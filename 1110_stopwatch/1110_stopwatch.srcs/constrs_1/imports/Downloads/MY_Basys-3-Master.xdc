...
#set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { run_stop  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
#set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { clear  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
