...
HD_PWD='D:/GitHub/verilog/Verilog/1231_AXI4_Lite_GPO/1231_AXI4_Lite_GPO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_Lite_Slave_GPO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI4_Lite_Slave_GPO.tcl -notrace
