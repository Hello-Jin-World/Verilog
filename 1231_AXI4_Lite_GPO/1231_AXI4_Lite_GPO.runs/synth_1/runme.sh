...
HD_PWD='D:/GitHub/verilog/Verilog/1231_AXI4_Lite_GPO/1231_AXI4_Lite_GPO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_Lite_Slave_GPO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI4_Lite_Slave_GPO.tcl
