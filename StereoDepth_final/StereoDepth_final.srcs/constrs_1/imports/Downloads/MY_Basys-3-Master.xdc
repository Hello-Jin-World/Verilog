...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { depth2rgb_sw  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { ssd_sad_select     }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { census_select   }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { gray_sw  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
...
# set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
# set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports {  ssd_sad_select}]; #IO_L1P_T0_34               ,Sch=SW15


## LEDs

# set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
# set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
# set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
# set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
# set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[4]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
# set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[5]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
# set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[6]  }]; #IO_25_14                     ,Sch=LED6
# set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { DATA_0_L[7]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
...
# set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports { start }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
...
set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[0] }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
set_property -dict { PACKAGE_PIN L2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[2] }]; #IO_L5N_T0_AD13N_35    ,Sch=JA2
set_property -dict { PACKAGE_PIN J2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[4] }]; #IO_L2N_T0_AD12N_35    ,Sch=JA3
set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[6] }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
set_property -dict { PACKAGE_PIN H1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[3] }]; #IO_L3P_T0_DQS_AD5P_35 ,Sch=JA7
set_property -dict { PACKAGE_PIN K2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_href1 }]; #IO_L5P_T0_AD13P_35    ,Sch=JA8
set_property -dict { PACKAGE_PIN H2  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[5] }]; #IO_L2P_T0_AD12P_35    ,Sch=JA9
set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[7] }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
# set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { ov7670_data2[0] }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
...
# set_property -dict { PACKAGE_PIN G2  IOSTANDARD LVCMOS33 } [get_ports { SCL_L }]; #IO_L1N_T0_AD4N_35     ,Sch=JA4
...
# set_property -dict { PACKAGE_PIN G3  IOSTANDARD LVCMOS33 } [get_ports { SDA_L }]; #IO_L1P_T0_AD4P_35     ,Sch=JA10
