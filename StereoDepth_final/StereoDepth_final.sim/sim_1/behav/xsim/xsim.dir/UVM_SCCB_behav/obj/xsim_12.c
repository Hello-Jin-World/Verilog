...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x41f708)) ;
...
extern "C" {
	...
	extern void subprog_m_f66af8f_556ead11_2254(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 1006400, 168, 151464) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_f66af8f_556ead11_2254), IP) ;
