...
namespace eval ::optrace {
  variable script "D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0.tcl"
...
set_param synth.incrementalSynthesisCache C:/Users/kccistc/AppData/Roaming/Xilinx/Vivado/.Xil/Vivado-15732-DESKTOP-7CFQ9ND/incrSyn
...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1 -new_name ila_0 -ip [get_ips ila_0]]
...
if { [catch {
  file copy -force D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0.dcp d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0_stub.v d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0_stub.vhdl d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0_sim_netlist.v d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.runs/ila_0_synth_1/ila_0_sim_netlist.vhdl d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.v D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.ip_user_files/ip/ila_0
  }
}

if {[file isdir D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force d:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.gen/sources_1/ip/ila_0/ila_0_stub.vhdl D:/GitHub/harman_Verilog/DHT11_windows/DHT11_windows.ip_user_files/ip/ila_0
  }
}
