...
HD_PWD='D:/GitHub/harman_Verilog/if_case_diff/if_case_diff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_out.tcl
