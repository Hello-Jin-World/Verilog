...
HD_PWD='D:/GitHub/harman_Verilog/1106_up_counter/1106_up_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_up_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_up_counter.tcl -notrace
