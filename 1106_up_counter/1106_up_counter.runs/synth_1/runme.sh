...
HD_PWD='D:/GitHub/harman_Verilog/1106_up_counter/1106_up_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_up_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_up_counter.tcl
