...
HD_PWD='D:/GitHub/harman_Verilog/1111_hour_min_sec_msec_stopwatch/1111_hour_min_sec_msec_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_stopwatch.tcl
