...
HD_PWD='D:/GitHub/harman_Verilog/1206_1to10_add_lector/1206_1to10_add_lector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dedicated_processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dedicated_processor.tcl -notrace
