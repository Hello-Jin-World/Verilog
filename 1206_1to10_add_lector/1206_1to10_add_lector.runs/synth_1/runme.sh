...
HD_PWD='D:/GitHub/harman_Verilog/1206_1to10_add_lector/1206_1to10_add_lector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dedicated_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dedicated_processor.tcl
