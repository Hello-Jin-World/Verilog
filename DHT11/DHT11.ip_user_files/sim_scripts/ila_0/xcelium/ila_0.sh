...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../DHT11.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/project/Verilog/DHT11/DHT11.cache/compile_simlib/xcelium"
  fi
