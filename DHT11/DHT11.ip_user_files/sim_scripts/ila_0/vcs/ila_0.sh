...
#
# Script generated by Vivado on Sun Nov 24 08:56:28 +0000 2024
...
# script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../DHT11.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/user/project/Verilog/DHT11/DHT11.cache/compile_simlib/vcs"
  fi
