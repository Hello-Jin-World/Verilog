set_property SRC_FILE_INFO {cfile:D:/GitHub/verilog/Verilog/VGA_OV7670_PROJECT/VGA_OV7670_PROJECT.srcs/constrs_1/imports/Desktop/MY_Basys-3-Master.xdc rfile:../../../VGA_OV7670_PROJECT.srcs/constrs_1/imports/Desktop/MY_Basys-3-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN J3  IOSTANDARD LVCMOS33 } [get_ports { dataPort }]; #IO_L7P_T1_AD6P_35     ,Sch=XA1_P
...
set_property -dict { PACKAGE_PIN B18  IOSTANDARD LVCMOS33 } [get_ports { rxd }]; #IO_L19P_T3_16      ,Sch=UART_TXD_IN
set_property src_info {type:XDC file:1 line:147 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN A18  IOSTANDARD LVCMOS33 } [get_ports { txd }]; #IO_L19N_T3_VREF_16 ,Sch=UART_RXD_OUT
