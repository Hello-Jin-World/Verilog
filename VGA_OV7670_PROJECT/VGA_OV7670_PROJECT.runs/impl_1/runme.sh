...
HD_PWD='D:/GitHub/verilog/Verilog/VGA_OV7670_PROJECT/VGA_OV7670_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_OV7670_Test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_OV7670_Test.tcl -notrace
